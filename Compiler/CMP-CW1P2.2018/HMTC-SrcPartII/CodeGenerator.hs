...
peepholeOpt' tis = poAux [] tis'
    where
        ...
        -- Need to ensure that ti is "unmoved" by the optimizations before
        -- pushing considering it processed. Otherwise we risk e.g. missing
        -- changing a jump target. So having this code earlier introduces
        -- very subtle bugs!
