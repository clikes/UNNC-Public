...
-- Note - There appears to be a Happy bug - You will be required to reorganise 
-- the output in Parser.hs slightly.
-- Ensure that the following lines appear before this "parse" definition:
